...
- 當要呈現的資訊結構相似，並且內容過多時，可以透過 Accordion 來隱藏內容。例如: 常見問題區塊 <ToolTip className="width-[5px]"><Image
      src="https://imgur.com/b70jF3q.png"
      height="440"
      width="623"
      showalt
      sourceTitle="Airbnb FAQ"
      sourceUrl="https://www.airbnb.com/host/homes"
    /></ToolTip>。
