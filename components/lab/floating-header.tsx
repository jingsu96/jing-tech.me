...
export const FloatingHeader = memo(
  ({
    ...
    return (
      <header className="sticky inset-x-0 top-0 z-10 mx-auto flex h-12 w-full shrink-0 items-center overflow-hidden bg-bg-primary text-sm font-medium lg:hidden">
        <div className="flex size-full items-center px-3">
          <div className="flex w-full items-center justify-between gap-2">
            ...
            <ThemeSwitch className="mr-4 inline-flex items-center" />
